...
- `src/ibis_profiling/templates/default.html`: React-based template for the report.
...
- In `src/ibis_profiling/templates/default.html`, find the "Job Duration" display.
...
- In `src/ibis_profiling/templates/default.html`, modify `NullityMatrix` component.
